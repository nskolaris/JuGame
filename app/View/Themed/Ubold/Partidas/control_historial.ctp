<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<h4 class="m-t-0 header-title"><b>Historial partidas</b></h4>
			<table class="tablesaw m-t-20 table m-b-0" data-tablesaw-mode="stack">
				...
				<?php
					foreach($partidas as $partida)
					{
						...
						echo 
							'<td>
								<a href="'.$this->Html->url(array('controller'=>'partidas','action'=>'ver',$partida['Partida']['id'])).'" class="on-default remove-row"><i class="fa fa-search"></i></a>
