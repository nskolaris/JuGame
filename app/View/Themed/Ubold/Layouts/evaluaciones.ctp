                ...
                <div class="topbar-left">
                    <div class="text-center">
                       <!-- <a href="index.html" class="logo"><i class="icon-magnet icon-c-logo"></i><span>Ub<i class="md md-album"></i>ld</span></a>-->
                        <a href="javascript:void(0);" class="logo"><i class="icon-magnet icon-c-logo"></i><span>Pruebas</span></a>
                    </div>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							<li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-menu-alt"></i><span>Evaluaciones</span></a>
								<ul class="list-unstyled">
									<li><a href="<?php echo $this->Html->url(array("controller" => "escuelas","action" => "index")); ?>">Lista de Evaluaciones</a></li>
                                    <li><a href="<?php echo $this->Html->url(array("controller" => "escuelas","action" => "add")); ?>">Nueva Evaluación</a></li>
								</ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-menu-alt"></i><span>Usuarios</span></a>
								<ul class="list-unstyled">
									<li><a href="<?php echo $this->Html->url(array("controller" => "juegos","action" => "index")); ?>">Lista de Usuarios</a></li>
								</ul>
                            </li>
							<li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-menu-alt"></i><span>Preguntas</span></a>
								<ul class="list-unstyled">
									<li><a href="<?php echo $this->Html->url(array("controller" => "partidas","action" => "index")); ?>">Lista de Preguntas</a></li>
									<li><a href="<?php echo $this->Html->url(array("controller" => "partidas","action" => "historial")); ?>">Nueva Pregunta</a></li>
								</ul>
                            </li>
                        </ul>
