                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                <li class="dropdown">
                                    <a href="page-starter.html" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="images/users/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="javascript:void(0)"><i class="ti-user m-r-5"></i> Profile</a></li>
                                        <li><a href="javascript:void(0)"><i class="ti-settings m-r-5"></i> Settings</a></li>
                                        <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li>
                                        <li><a href="<?php echo $this->Html->url(array('controller'=>'usuarios','action'=>'login','director'=>false)); ?>"><i class="ti-power-off m-r-5"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-menu-alt"></i><span>Grados</span></a>
								<ul class="list-unstyled">
									<li><a href="<?php echo $this->Html->url(array("controller"=>"grados","action"=>"index")); ?>">Lista Grados</a></li>
                                    <li><a href="<?php echo $this->Html->url(array("controller"=>"grados","action"=>"agregar")); ?>">Agregar Grado</a></li>
								</ul>
                            </li>
                        </ul>
