                    ...
                    <div class="navbar navbar-toolbar">
                        ...
                        <li class="dropdown navbar-profile">
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                ...
                                <li class="divider"></li>-->
                                <li><a href="<?php echo $this->Html->Url(array('controller'=>'usuarios','action'=>'login')); ?>"><i class="fa fa-sign-out"></i>Logout</a></li>
                            </ul>
                            <!--/ End dropdown menu -->
                        </li>
                        <!--/ End profile -->
            ...
            <aside id="sidebar-left" class="sidebar-circle">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            <li><a href="<?php echo $this->Html->Url(array('controller'=>'usuarios','action'=>'index')); ?>">Lista</a></li>
                            <li><a href="<?php echo $this->Html->Url(array('controller'=>'usuarios','action'=>'agregarAdministrador')); ?>">Agregar Administrador</a></li>
                            <li><a href="<?php echo $this->Html->Url(array('controller'=>'usuarios','action'=>'agregarPromotora')); ?>">Agregar Promotora</a></li>
                        </ul>
                    </li>
					...
					<li class="submenu">
                        ...
                        <ul>
                            <li><a href="<?php echo $this->Html->Url(array('controller'=>'eventos','action'=>'index')); ?>">Lista</a></li>
                            <li><a href="<?php echo $this->Html->Url(array('controller'=>'eventos','action'=>'agregar')); ?>">Agregar</a></li>
                        </ul>
                    </li>
                ...
                <div class="sidebar-footer hidden-xs hidden-sm hidden-md">
                    ...
                    <a id="logout" class="pull-left" href="<?php echo $this->Html->Url(array('controller'=>'usuarios','action'=>'login')); ?>" data-toggle="tooltip" data-placement="top" data-title="Logout"><i class="fa fa-power-off"></i></a>
                </div><!-- /.sidebar-footer -->
